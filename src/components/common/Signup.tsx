...
const Signup = () => {
  ...
  const formSubmit = async (data: FormData) => {
    ...
    if (validations.validateFirstNameAndSecondName(data?.firstName, data?.lastName)) {
    ...
    const res: errorObject = validations.validatePassword(data?.password, data?.confirmPassword)
    if (res?.error) {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center justify-center md:mt-20 px-6 py-8 mx-auto md:h-screen lg:py-0">
